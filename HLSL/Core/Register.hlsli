...
#define REG_U(slot_num) ::engine::RegisterU(slot_num)
...
#define REG_B_PER_MATERIAL_END     REG_B_PER_DRAW_START
#define REG_B_PER_MATERIAL_COUNT 	(REG_B_PER_MATERIAL_END - REG_B_PER_MATERIAL_START)

// Per Draw / Dispatch
#define REG_B_PER_DRAW_START   11   // b11~b13 (3칸)
#define REG_B_PER_DRAW_0       REG_B(11)
#define REG_B_PER_DRAW_1       REG_B(12)
#define REG_B_PER_DRAW_2       REG_B(13)
#define REG_B_PER_DRAW_END     14
#define REG_B_PER_DRAW_COUNT 	(REG_B_PER_DRAW_END - REG_B_PER_DRAW_START)
// ==========================================
...
#define REG_T_PER_MATERIAL_END     REG_T_PER_DRAW_START
#define REG_T_PER_MATERIAL_COUNT  (REG_T_PER_MATERIAL_END - REG_T_PER_MATERIAL_START)

// Per Draw / Dispatch
#define REG_T_PER_DRAW_START   40
#define REG_T_PER_DRAW_0       REG_T(40)
#define REG_T_PER_DRAW_1       REG_T(41)
#define REG_T_PER_DRAW_2       REG_T(42)
#define REG_T_PER_DRAW_3       REG_T(43)
#define REG_T_PER_DRAW_4       REG_T(44)
#define REG_T_PER_DRAW_5       REG_T(45)
#define REG_T_PER_DRAW_6       REG_T(46)
#define REG_T_PER_DRAW_7       REG_T(47)
#define REG_T_PER_DRAW_8       REG_T(48)
#define REG_T_PER_DRAW_9       REG_T(49)
#define REG_T_PER_DRAW_END     50
#define REG_T_PER_DRAW_COUNT  (REG_T_PER_DRAW_END - REG_T_PER_DRAW_START)
// ==========================================
